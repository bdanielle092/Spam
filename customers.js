...
//   The forEach is runnig through the array of customers the second forEach is stepping into the customer object and the push is adding the emails to the new array
   const emails = []
   customers.forEach(customer => customer.contacts.email.forEach(email => {
      emails.push(email)
 })) 
 console.log(emails)
